...
import { Box, Modal, IconButton, Typography, Button, TextField, FormControl, InputLabel, MenuItem, Select } from "@material-ui/core";
...
const AddList = (props) => {
    const {listTitle, listOpen, changeListOpen, addProductOpen, changeAddProductOpen, demoListsArray} = props;
    ...
    return (
        ...
        <Box className={classes.paper}>
          ...
          <Box className={classes.bodyContainer}>
            <Typography className={classes.itemText}>Paste link to item:</Typography>
          </Box>
          ...
          <FormControl variant="outlined" fullWidth className={classes.formControl}>
            ...
            >
              {demoListsArray.map((list, i) => (
                <MenuItem key={i} value={list.listTitle}>{list.listTitle}</MenuItem>
              ))}
            </Select>
          </FormControl>
          </Box>
          <Box className={classes.addButtonContainer}>
            <Button className={classes.addButton} variant="contained">ADD ITEM</Button>
          </Box>
        </Box>
        </Modal>
    );
